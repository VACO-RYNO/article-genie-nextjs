...
export const createArticle = async (userId, article) => {
  const { data } = await API.post(`/api/users/${userId}/articles`, {
    ...article,
  });
...
export const updateLastVisitedSite = (userId, articleId, lastVisitedSiteInfo) =>
  API.patch(`/api/users/${userId}/articles/${articleId}`, {
    lastVisitedSiteUrl: lastVisitedSiteInfo.originUrl,
    lastVisitedSiteOgImgSrc: lastVisitedSiteInfo.ogImgSrc,
  });
